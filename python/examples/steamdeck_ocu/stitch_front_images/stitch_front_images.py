...
def stitch(robot, options):
    ...
    displaySize = (infoObject.current_w, infoObject.current_h)
    pygame.display.set_mode(displaySize, pygame.DOUBLEBUF | pygame.OPENGL | pygame.FULLSCREEN)
    ...
    while running:
        # infoObject = pygame.display.Info()
        # displaySize = (infoObject.current_w, infoObject.current_h-100)
        # pygame.display.set_mode(display, pygame.DOUBLEBUF | pygame.OPENGL)
        # pygame.display.set_mode(displaySize, pygame.DOUBLEBUF | pygame.OPENGL | pygame.FULLSCREEN)
        ...
        draw_routine(displaySize, program, stitching_camera)
        pygame.display.flip()
        clock.tick(30)
